...
//         <span class="country-info__weight">Capital:</span>${capital}
//       </p>
//       <p class="country-info__population">
//         <span class="country-info__weight">Population:</span> ${population}</p>
//       <p class="country-info__languages">
//         <span class="country-info__weight">Languages:</span> ${Object.values(languages)}</p>
//     </div>
//   `
// };
